...
public class SalesAnalysisServiceTest {
    ...
    public void setUp() {
        ...
        createBookingAndPayment(
                normalUser1, testHotel, standardRoom, "B260501", 1, 
        ...
        createBookingAndPayment(
                vipUser, testHotel, suiteRoom, "B260502", 2, 
        ...
        createBookingAndPayment(
                normalUser1, testHotel, deluxeRoom, "B260601", 1, 
        ...
        createBookingAndPayment(
                vipUser, testHotel, suiteRoom, "B260602", 3, 
        ...
        createBookingAndPayment(
                normalUser2, testHotel, standardRoom, "B260603", 1, 
    ...
    private void createBookingAndPayment(
            User user, Hotel hotel, Room room, String bookingNo, int nights,
    ...
    public void testSalesDashboardStatistics() {
        ...
        assertThat(response.getHotelName()).isEqualTo("테스트 MJC Hotel".replace("Hotel", "호텔"));
        ...
        assertThat(response.getMetrics().getTotalRevenue().getValue()).isEqualTo(1150000.00);
        ...
        assertThat(response.getMetrics().getBookingCount().getValue()).isEqualTo(3.0);
