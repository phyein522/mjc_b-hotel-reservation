...
public class HotelImageRestController {
    ...
    public ResponseEntity<ApiResponse<HotelImageResponseDto>> insert(
        ...
        HotelImageResponseDto resultDto =
                this.hotelImageService.insert(requestDto);
    ...
    public ResponseEntity<ApiResponse<HotelImageResponseDto>> uploadAndInsert(
        ...
        HotelImageResponseDto resultDto =
                this.hotelImageService.uploadAndInsert(hotelId, file);
    ...
    public ResponseEntity<ApiResponse<HotelImageResponseDto>> update(
        ...
        HotelImageResponseDto resultDto =
                this.hotelImageService.update(requestDto);
    ...
    public ResponseEntity<ApiResponse<HotelImageResponseDto>> uploadAndUpdate(
        ...
        HotelImageResponseDto resultDto =
                this.hotelImageService.uploadAndUpdate(hotelImageId, file);
    ...
    public ResponseEntity<ApiResponse<HotelImageResponseDto>> findById(
            @PathVariable Long hotelImageId) {

        HotelImageResponseDto resultDto =
                this.hotelImageService.findById(hotelImageId);
    ...
    public ResponseEntity<ByteArrayResource> downloadImageById(
            @PathVariable Long hotelImageId) throws IOException {

        HotelImageDto findDto =
                this.hotelImageService.findById(hotelImageId);

        byte[] result =
                this.hotelImageService.getImageBytesById(findDto);
        ...
        return ResponseEntity.ok()
                ...
                .header(
                        "Content-disposition",
                        "attachment; filename=\"" +
                                URLEncoder.encode(findDto.getFileName(), StandardCharsets.UTF_8)
                                + "\"")
                .body(resource);
    }

    @GetMapping("/image/{hotelImageId}")
    public ResponseEntity<Resource> resourceImageById(
            @PathVariable Long hotelImageId) throws IOException {
        ...
        Resource result =
                this.hotelImageService.getImageResourceById(findDto);
    ...
    public ResponseEntity<ApiResponse<HotelImageDto>> deleteById(
        ...
        HotelImageDto resultDto =
                this.hotelImageService.deleteById(hotelImageId);
    ...
    public ResponseEntity<ApiResponse<Page<HotelImageResponseDto>>> page(
            @PathVariable Long hotelId,
            @PageableDefault(size = 10, page = 0, sort = "hotelImageId",
                    direction = Sort.Direction.DESC)
            Pageable pageable) {

        Page<HotelImageResponseDto> page =
                this.hotelImageService.findAllByHotelIdEquals(hotelId, pageable);
